...
execute unless data entity @s Inventory[{Slot:-106b}].components."minecraft:enchantments" run return run function enchantment_extraction_book:cancel {"hand":"main"}
...
data modify entity @n[tag=enchantment_extraction_book.armor_stand] HandItems[1].components."minecraft:stored_enchantments" set from entity @n[tag=enchantment_extraction_book.armor_stand] HandItems[0].components."minecraft:enchantments"
data remove entity @n[tag=enchantment_extraction_book.armor_stand] HandItems[0].components."minecraft:enchantments"
